...
const Header = ({refreshKey}) => {
    ...
    return (
        <header
            className="fixed top-0 left-0 w-full h-16 flex justify-between items-center px-6 py-4 bg-white shadow z-50">
                ...
                {user ? (
                    ...
                    <>
                        <button onClick={() => navigate('/sign-up')}
                                className="text-lg text-blue-500 hover:text-blue-600">Sign
                            up
                        </button>
                        <button onClick={() => navigate('/login')}
                                className="text-lg text-blue-500 hover:text-blue-600">Login
                        </button>
                    </>
                )}
            </div>
